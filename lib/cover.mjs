...
// Split word timestamps into beats, preferring sentence ends (word text
// ending . ! ?), never shorter than minSec or longer than maxSec. The last
// beat extends to the full piece duration.
export function segmentWords(words, pieceDur, { minSec = 4, maxSec = 9 } = {}) {
